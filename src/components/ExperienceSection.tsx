  ...
  return (
    <section className="w-full flex flex-col md:flex-row justify-center items-start gap-6 md:gap-12 py-8 sm:py-16 md:py-24">
      ...
      <div 
        ...
        className={`w-full md:w-1/2 min-h-[200px] sm:min-h-[400px] md:min-h-[600px] flex items-center mt-10justify-left transition-all duration-1000 ease-in-out transform ${
